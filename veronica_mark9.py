...
while running:
    ...
    # Radar sweep effect
    radar_x, radar_y = master_drone.x, master_drone.y
    ...
    pygame.draw.circle(screen, NEON_PURPLE, (int(radar_x), int(radar_y)), RADAR_RANGE, 1)
    pygame.draw.line(screen, NEON_PURPLE, (int(radar_x), int(radar_y)), (int(radar_x_end), int(radar_y_end)), 2)
